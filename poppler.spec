...
Source0  : https://poppler.freedesktop.org/poppler-0.66.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause GPL-2.0 GPL-3.0
Requires: poppler-bin
Requires: poppler-lib
Requires: poppler-license
Requires: poppler-man
BuildRequires : cmake
...
%prep
%setup -q -n poppler-0.66.0
pushd ..
cp -a poppler-0.66.0 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1530989266
mkdir clr-build
pushd clr-build
...
cp COPYING3 %{buildroot}/usr/share/doc/poppler/COPYING3
cp COPYING %{buildroot}/usr/share/doc/poppler/COPYING
cp cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/doc/poppler/cmake_modules_COPYING-CMAKE-SCRIPTS
...
/usr/lib64/haswell/libpoppler.so.77
/usr/lib64/haswell/libpoppler.so.77.0.0
...
/usr/lib64/libpoppler.so.77
/usr/lib64/libpoppler.so.77.0.0

%files license
%defattr(-,root,root,-)
/usr/share/doc/poppler/COPYING
/usr/share/doc/poppler/COPYING3
/usr/share/doc/poppler/cmake_modules_COPYING-CMAKE-SCRIPTS
