...
Source0  : https://poppler.freedesktop.org/poppler-0.65.0.tar.xz
...
%prep
%setup -q -n poppler-0.65.0
pushd ..
cp -a poppler-0.65.0 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1526827107
mkdir clr-build
pushd clr-build
...
/usr/lib64/haswell/libpoppler.so.76
/usr/lib64/haswell/libpoppler.so.76.0.0
...
/usr/lib64/libpoppler.so.76
/usr/lib64/libpoppler.so.76.0.0
